                ...
                <div className="bg-background rounded-[2.5rem] overflow-hidden aspect-[9/19]">
                  ...
                  <div className="h-full flex flex-col">
                    ...
                    <div className="flex items-center justify-between px-6 py-3 text-xs text-muted-foreground">
                      ...
                      <div className="flex items-center gap-1">
                        <div className="w-4 h-2 border border-muted-foreground rounded-sm">
                          <div className="w-3/4 h-full bg-[#8DC63F] rounded-sm" />
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="px-5 py-4">
                      <h3 className="text-xl font-bold text-primary">FLOCK</h3>
                    ...
                    {/* Featured Song */}
                    <div className="mx-4 bg-primary rounded-2xl p-5 text-primary-foreground">
            ...
            <div className="mt-10 grid sm:grid-cols-2 gap-6">
              {features.map((feature) => (
                <div key={feature.title} className="flex items-start gap-4">
                  <div className="w-2 h-2 rounded-full bg-[#5ABCB9] mt-2.5 flex-shrink-0" />
                  <div>
