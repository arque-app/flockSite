      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {resources.map((resource) => (
            <div
              key={resource.title}
              className="group bg-card border border-border rounded-2xl p-8 hover:border-accent/50 transition-all"
            >
              <div className="w-12 h-12 rounded-xl bg-secondary flex items-center justify-center mb-6 text-foreground group-hover:bg-accent group-hover:text-accent-foreground transition-colors">
                {resource.icon}
              </div>
